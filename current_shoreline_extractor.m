...
csvFolder = ...
'C:\Users\6679242\Documents\Shoreshop3\Data\HistoricalShorelines_NC';
...
outputFile = ...
'Current_shoreline_Cape_Hatteras.csv';
...
for i = 1:n
    ...
    [dates,idx] = sort(dates,'descend');

    xs = xs(idx);



    % Current CoastSat shoreline distance
...
NOW = table(...
    ...
    ...
    'VariableNames',...
    {'id','date','x_s','UTM_E','UTM_N'});


writetable(NOW,outputFile)
...
title(['CoastSat Current shoreline in BRIE coordinates'])
